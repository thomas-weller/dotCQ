// ************************************************************************************************************************************************************
// <copyright file="IWidgetDataGeckoMeter.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/geck-o-meter/">
    /// Geck-O-Meter</see> widget.
    /// </summary>
    public interface IWidgetDataGeckoMeter : IWidgetData
    {
        double CurrentValue { get; set; }

        IValueAndTextDataPoint Min { get; }

        IValueAndTextDataPoint Max { get; }

    } // interface IWidgetDataGeckoMeter
