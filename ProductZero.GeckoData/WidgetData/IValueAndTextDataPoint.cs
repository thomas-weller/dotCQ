// ************************************************************************************************************************************************************
// <copyright file="IValueAndTextDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IValueAndTextDataPoint : IJsonData
    {
        double Value { get; set; }
	
        string Text { get; set; }
	
    } // interface IValueAndTextDataPoint
