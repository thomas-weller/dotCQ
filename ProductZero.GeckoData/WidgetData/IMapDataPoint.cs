// ************************************************************************************************************************************************************
// <copyright file="IMapDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IMapDataPoint : IJsonData
    {
        /// <summary>
        /// Gets or sets the location.
        /// </summary>
        /// <value>
        /// Either IP (v4) or an Url is accepted.
        /// </value>
        string Location { get; set; }
	
        MapDataPointLocationType LocationType { get; }
