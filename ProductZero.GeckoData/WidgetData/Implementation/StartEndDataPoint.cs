// ************************************************************************************************************************************************************
// <copyright file="StartEndDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.WidgetData.Implementation
{
    ...
    internal class StartEndDataPoint : IStartEndDataPoint
    {
        ...
        {
            stringBuilder.Append("\"start\":" + Math.Round(this.Start, 2).ToString(CultureInfo.InvariantCulture) + ",");
            stringBuilder.Append("\"end\":" + Math.Round(this.End, 2).ToString(CultureInfo.InvariantCulture));
        }
