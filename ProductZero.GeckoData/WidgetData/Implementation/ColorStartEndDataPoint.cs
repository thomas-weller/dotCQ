// ************************************************************************************************************************************************************
// <copyright file="ColorStartEndDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.WidgetData.Implementation
{
    ...
    internal class ColorStartEndDataPoint : StartEndDataPoint, IColorStartEndDataPoint
    {
        protected override void AppendData(System.Text.StringBuilder stringBuilder)
        {
            stringBuilder.Append("\"color\":\"" + this.Color + "\",");

            base.AppendData(stringBuilder);
        }

        public string Color { get; set; }

    } // class ColorStartEndDataPoint
