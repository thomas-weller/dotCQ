...
{
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/pie-chart/">
    /// Pie Chart</see> widget.
    /// </summary>
    public interface IWidgetDataPieChart : IWidgetData
    {
        void AddSlice(double value, string label, string color);
