// ************************************************************************************************************************************************************
// <copyright file="IWidgetDataLineChart.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.WidgetData
{
    ...
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/line-chart/">
    /// Line Chart</see> widget.
    /// </summary>
    public interface IWidgetDataLineChart : IWidgetData
    {
        IList<double> Items { get; }

        IList<string> AxisX { get; }

        IList<string> AxisY { get; }

        string Color { get; set; }

    } // interface IWidgetDataLineChart
