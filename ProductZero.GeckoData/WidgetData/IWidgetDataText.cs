// ************************************************************************************************************************************************************
// <copyright file="IWidgetDataText.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/text/">
    /// Text</see> widget.
    /// </summary>
    public interface IWidgetDataText : IWidgetData
    {
        void AddText(string text, WidgetCornerType cornerType = WidgetCornerType.None);

    } // interface IWidgetDataText
