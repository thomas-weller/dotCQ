// ************************************************************************************************************************************************************
// <copyright file="IValueAndLabelDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IValueAndLabelDataPoint : IJsonData
    {
        double Value { get; set; }
	
        string Label { get; set; }

    } // interface IValueAndLabelDataPoint
