// ************************************************************************************************************************************************************
// <copyright file="IWidgetDataFunnel.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/funnel/">
    /// Funnel</see> widget.
    /// </summary>
    public interface IWidgetDataFunnel : IWidgetData
    {
        void AddStep(int value, string label);

        bool ShowPercentage { get; set; }

        bool GreenOnTop { get; set; }

    } // interface IWidgetDataFunnel
