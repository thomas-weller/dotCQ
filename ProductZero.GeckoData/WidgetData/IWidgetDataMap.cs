// ************************************************************************************************************************************************************
// <copyright file="IWidgetDataMap.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    /// <summary>
    /// Provides data for <see href="http://www.geckoboard.com/developers/custom-widgets/widget-types/map">
    /// Map</see> widget.
    /// </summary>
    public interface IWidgetDataMap : IWidgetData
    {
        void AddLocation(string location);

    } // interface IWidgetDataMap
