// ************************************************************************************************************************************************************
// <copyright file="IStartEndDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IStartEndDataPoint : IJsonData
    {
        double Start { get; set; }
	
        double End { get; set; }
	
    } // interface IStartEndDataPoint
