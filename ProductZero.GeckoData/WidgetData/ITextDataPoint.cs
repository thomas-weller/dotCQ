// ************************************************************************************************************************************************************
// <copyright file="ITextDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface ITextDataPoint : IJsonData
    {
        string Text { get; set; }
	
        WidgetCornerType CornerType { get; set; }
	
    } // interface ITextDataPoint
