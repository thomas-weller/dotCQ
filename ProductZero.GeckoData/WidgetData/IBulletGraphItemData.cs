// ************************************************************************************************************************************************************
// <copyright file="IBulletGraphItemData.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.WidgetData
{
    ...
    public interface IBulletGraphItemData : IJsonData
    {
        string Label { get; set; }

        string Sublabel { get; set; }

        IList<double> Scale { get; }

        IColorStartEndDataPoint FirstRange { get; }

        IColorStartEndDataPoint MiddleRange { get; }

        IColorStartEndDataPoint LastRange { get; }

        IStartEndDataPoint CurrentMeasure { get; }

        IStartEndDataPoint ProjectedMeasure { get; }

        double? ComparativeMeasure { get; set; }

    } // interface IBulletGraphItemData
