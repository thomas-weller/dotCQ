// ************************************************************************************************************************************************************
// <copyright file="IWidgetData.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.WidgetData
{
    ...
    public interface IWidgetData : IJsonData
    {
        WidgetType CorrespondingWidgetType { get; }
