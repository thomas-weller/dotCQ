// ************************************************************************************************************************************************************
// <copyright file="IColorStartEndDataPoint.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IColorStartEndDataPoint : IStartEndDataPoint
    {
        string Color { get; set; }
	
    } // interface IColorStartEndDataPoint
