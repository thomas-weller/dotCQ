// ************************************************************************************************************************************************************
// <copyright file="IGeckoboardWidget.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
{
    public interface IGeckoboardWidget
    {
        string Name { get; set; }

	    WidgetType Type { get; set; }

        string S3FileKey { get; set; }

    } // interface IGeckoboardWidget
