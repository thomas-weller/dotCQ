// ************************************************************************************************************************************************************
// <copyright file="CanonicalUserIdElement.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.Configuration
{
    ...
    public class CanonicalUserIdElement : ConfigurationElement
    {
