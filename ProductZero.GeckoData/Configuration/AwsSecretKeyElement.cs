// ************************************************************************************************************************************************************
// <copyright file="AwsSecretKeyElement.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.Configuration
{
    ...
    public class AwsSecretKeyElement : ConfigurationElement
    {
