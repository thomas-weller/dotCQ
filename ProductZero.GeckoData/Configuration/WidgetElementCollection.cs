// ************************************************************************************************************************************************************
// <copyright file="WidgetElementCollection.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.Configuration
{
    ...
    public class WidgetElementCollection : ConfigurationElementCollection
    {
        public WidgetElement this[int index]
        {
            get
            {
                return base.BaseGet(index) as WidgetElement;
            }
            set
            {
        ...
        {
            return ((WidgetElement)element).Name;
        }

    } // class WidgetElementCollection
