// ************************************************************************************************************************************************************
// <copyright file="AwsAccessKeyIdElement.cs" company="dotCQ Software Development Ltd. & Co. KG">
...
namespace ProductZero.GeckoData.Configuration
{
    ...
    public class AwsAccessKeyIdElement : ConfigurationElement
    {
